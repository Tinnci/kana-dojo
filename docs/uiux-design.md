...
- English and Simplified Chinese string resources are covered by tests for key parity and format-placeholder parity.
...
- App shell now chooses compact or expanded layout mode once, using bottom navigation on compact width and a navigation rail on expanded width.
- Global navigation is tested to hide during immersive lesson and practice question flow, then return for intro, completion, and browsing states.
...
- Reduced-motion coverage for screen changes, path progress/elevation, answer feedback, trace feedback, practice panels, and lesson-completion reveal motion.
...
- Added tested compact completion action-button accessibility role-chip tone fallback audit.
- Added tested compact completion action-button accessibility role-chip semantic exclusion audit.
- Added tested compact completion action-button accessibility role-chip semantic exclusion mode audit.
- Added tested compact completion action-button accessibility role-chip semantic exclusion fallback audit.
- Added tested compact completion action-button accessibility action-button semantic merge audit.
- Added tested compact completion action-button accessibility action-button semantic merge mode audit.
- Added tested compact completion action-button accessibility action-button semantic merge disabled-copy audit.
- Added tested compact completion action-button accessibility action-button semantic merge traversal audit.
